...
public class IntegrationTest {
    ...
    @Test
    public void addVolunteertoAssignment() {
        running(testServer(3333, fakeApplication(inMemoryDatabase())), HTMLUNIT, browser -> {
            ...
            // add the test volunteer to the assignment
            browser.find(".add-link").click();
            browser.find(".glyphicon-plus").click();

            // verify "first last" is in assigned volunteers table
            assertTrue(browser.$("table td a").getText().contains("first"));
    ...
    @Test
    public void removeVolunteerFromAssignment() {
        running(testServer(3333, fakeApplication(inMemoryDatabase())), HTMLUNIT, browser -> {
            ...
            browser.find(".glyphicon-remove").click();

            // verify the the "add volunteers" help block is visible
            assertTrue(browser.find((".help-block")).getText().contains("Add volunteers from the list below."));
